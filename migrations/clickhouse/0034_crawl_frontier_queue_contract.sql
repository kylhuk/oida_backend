...
-- migrate:compatibility_notes Reapply IF NOT EXISTS queue columns so older environments converge without rewriting prior migrations.
-- migrate:approval_ref roadmap/task-2
