...
### Numbered Tasks
- [ ] 1. Create the route contract source of truth
...
- [ ] 2. Add shared-key auth middleware for protected data routes
...
- [ ] 3. Enrich `/v1/schema` into a frontend-usable contract endpoint
...
- [ ] 4. Publish detailed markdown API reference from the same route metadata
...
- [ ] 5. Upgrade package and contract tests for auth, schema, and docs parity
...
- [ ] 6. Align runtime wiring, E2E verification, and entry-point docs
...
### Numbered Tasks
- [ ] 1. Freeze frontend route inventory, schema discoverability, and API reference
...
- [ ] 2. Repair nested entity relation views and live route correctness
...
- [ ] 3. Add browser preflight/CORS support for frontend REST access
...
- [ ] 4. Normalize frontend-facing scalar typing
...
- [ ] 5. Replace synthetic source coverage with observed coverage state
...
- [ ] 6. Restore explainability and evidence on REST analytics surfaces
...
- [ ] 7. Rebuild authoritative source catalog artifacts and collision-safe bronze naming
...
- [ ] 8. Materialize one bronze table per source and remove hardcoded 7-table assumptions
...
- [ ] 9. Close runtime blind spots in e2e/contract coverage and finalize frontend-facing docs
