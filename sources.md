...
| VesselFinder | global maritime | browser-rendered ship detail pages, vessel metadata, and recent positions | `maritime, ais, vessel, browser-rendered, global` | public site; live crawling is opt-in and rate-limited | https://www.vesselfinder.com/ |
| VesselFinder Routes | global maritime | VesselFinder planned route and waypoint API — fetched per-MMSI via browser to bypass anti-bot protection. | `maritime, ais, vessel, browser-rendered, global` | public site; live crawling is opt-in and rate-limited | https://www.vesselfinder.com/ |
